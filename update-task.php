                ...
                <form method ="POST" action="">
                    <table>
                            ...
                            <tr>
                                ...
                                <td><input type="textarea"  value="<?php echo $task_description; ?>"/></td>
                            </tr>
                            <tr>
                                <td>Select List:</td>
                                <td>
                                    <select name="list_id">
                                        <?php
                                            ...
                                            $db_select2 = mysqli_select_db($conn,DB_NAME) or die(mysqli_error());
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($res3==true)
            {
               ...
               header('location:'.SITEURL);
                ...
                $_SESSION['update_fail'] = "Failed to update tasks";
